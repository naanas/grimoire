            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
                    <button
                        ...
                        className={`whitespace-nowrap px-6 py-2 rounded-lg font-semibold transition-colors flex-1 md:flex-none text-center ${filter === 'pending'
                    ...
                    <button
                        ...
                        className={`whitespace-nowrap px-6 py-2 rounded-lg font-semibold transition-colors flex-1 md:flex-none text-center ${filter === 'all'
                            ? 'bg-red-600 text-white'
                            : 'bg-neutral-800 text-neutral-400 hover:text-white'
                            }`}
                    >
